...
sleep 1
echo ""
echo -e $white"[#]> Mr.X-CyberTron Was Here ... "
read enter
exit
}
...
echo  $white"         # $cyan  Contact Me In:$red dikkskyy@Gmail.com$white                #"
echo  $white"         # $cyan  Changelog: $red 06-11-2018   $white                        #"
echo  $white"         # $cyan  Team: $red Mr.X Team$white                                 #"
echo  $white"         # $cyan  My Fb: Satria Andhika Adi Saputra$white                #"
echo  $white"         # $cyan  Follow My Ig: @andhika907$white                        #"
echo  $white"         #                                                    #"
echo  $white"         ******************************************************"
echo ""
